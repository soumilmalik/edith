...
export function buildSystemPrompt({ profile, domains }) {
  return [
    ...
    "The user has a Task List panel (separate from calendar events) they can also add to and reorder by hand. Use list_tasks to see what's already there before adding more with add_task, so priority stays relative to the rest of the list - the panel always displays highest priority first.",
